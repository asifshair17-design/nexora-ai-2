...
export default function PricingPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-black via-gray-950 to-black text-white px-6 py-20">
      ...
      {/* =====================================================
          AL5SM AD #1 — ZONE 11632445
      ====================================================== */}
      <Script
        id="pricing-ad-11632445"
        strategy="afterInteractive"
        dangerouslySetInnerHTML={{
          __html: `
            (function(s){
              s.dataset.zone='11632445',
      ...
      {/* =====================================================
          AL5SM AD #2 — ZONE 11624956
      ====================================================== */}
      <Script
        id="pricing-ad-11624956"
        strategy="afterInteractive"
        dangerouslySetInnerHTML={{
          __html: `
            (function(s){
          ...
          <table className="w-full">
            ...
            <thead className="bg-gray-900">
              ...
              <tr>
                ...
                <th className="p-6 text-purple-400">
                  Pro
                </th>
